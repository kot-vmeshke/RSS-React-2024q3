...
const ThemeSwitch: FC = () => {
  ...
  return (
    <div className="flex items-center justify-between w-[80px] p-[4px] rounded-[32px] bg-color-bg-light dark:bg-dark-color-bg-light">
      <div>
        <input
        ...
        <label
          ...
          className="flex items-center justify-center w-[32px] h-[32px] shrink-0 rounded-[32px] text-color-text dark:text-dark-color-text opacity-40 transition-[0.5s] cursor-pointer peer-checked:bg-color-bg-dark dark:peer-checked:bg-dark-color-bg-dark peer-checked:opacity-100"
        >
          <svg
            width="18"
            height="18"
